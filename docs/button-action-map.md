...
| 시스템 설정 | 12개월 용량 계획 조회/새로고침 | `getCapacityPlanningReport`, `CapacityPlanningCard` | `GET /operations/capacity-planning` | Prisma aggregate count, 첨부 byte, 월별 성장률, DB/object storage 임계치, 첫 경고/위험 월, 권장 조치, `system:manage` 권한 |
