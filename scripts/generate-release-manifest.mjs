...
export const defaultReleaseManifestSections = [
  ...
  },
  {
    ...
    paths: [
      ...
      ".github/ISSUE_TEMPLATE/operations-improvement.yml",
      ...
      "backend/src/operations/capacityPlanningReport.ts",
      "backend/src/operations/dataQualityJobWorker.ts",
      "backend/src/security/logRedaction.ts",
      "backend/src/operations/permissionReviewReport.ts",
      "backend/src/operations/privacyAccessReport.ts",
      "backend/src/operations/auditIntegrityReport.ts",
      "scripts/generate-release-manifest.mjs",
      "scripts/start-local.mjs",
      "scripts/local-backup.mjs",
      "scripts/local-autostart.mjs",
      "scripts/local-supervisor.mjs",
      "scripts/local-profile.mjs",
      "scripts/verify-local-staging.mjs",
      "scripts/local-postgres.mjs",
      "scripts/stop-local.mjs",
      "scripts/local-status.mjs",
      "scripts/run-core-smoke-check.mjs",
      "scripts/run-synthetic-business-monitor.mjs",
      ...
      "tests/unit/userScopeIsolation.test.ts",
      "tests/unit/permissionReviewReport.test.ts",
      "tests/unit/operationsReportHttpContract.test.ts",
      "tests/unit/privacyAccessReport.test.ts",
      "tests/unit/auditIntegrityReport.test.ts",
      "tests/unit/syntheticBusinessMonitor.test.ts",
      "tests/unit/logApmRedaction.test.ts",
      "tests/unit/localHostingRuntime.test.ts",
      "tests/unit/localBackupRestore.test.ts",
      "tests/unit/localAutostart.test.ts",
      "tests/unit/localStagingProfile.test.ts",
      "tests/unit/internalActionForwarding.test.ts",
      "tests/unit/maintenanceReleasePolicy.test.ts",
      "tests/unit/capacityPlanningReport.test.ts",
