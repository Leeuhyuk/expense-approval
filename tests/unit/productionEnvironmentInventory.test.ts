...
function filledInventoryTemplate() {
  return readFileSync(resolve("docs/production-environment-inventory-template.md"), "utf8")
    ...
    .replace("| General administrator account policy | TBD |", "| General administrator account policy | role:general-admin |")
    .replace("| Break-glass account reference | TBD |", "| Break-glass account reference | account:break-glass-prod |")
    .replace("| Break-glass approval workflow | time-boxed, multi-approval, audited |", "| Break-glass approval workflow | approval:BG-2026-07 |")
    .replace("| Break-glass audit evidence | TBD |", "| Break-glass audit evidence | audit:BG-2026-07 |")
    .replace("| Break-glass revoke evidence | TBD |", "| Break-glass revoke evidence | audit:BG-2026-07-REVOKED |")
